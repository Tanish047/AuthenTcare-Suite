...
const ChatSettings = ({ settings, onSettingsChange, onClose, aiStatus }) => {
    ...
    const temperatureOptions = [
        ...
        { value: 0.7, label: 'Balanced (0.7)', description: 'Good balance of creativity and consistency' },
                ...
                <div className="setting-group">
                    ...
                    <div className="temperature-options">
                        {temperatureOptions.map(option => (
                            <button
                                key={option.value}
                                className={`temperature-btn ${settings.temperature === option.value ? 'active' : ''
                                    }`}
                        ...
                        <div className="toggle-item">
                            <label className="toggle-label">
                                ...
                                <div className="toggle-text">
                                    ...
                                    <span className="toggle-description">Use document knowledge base for responses</span>
                                </div>
                            </label>
                    ...
                    <div className="preset-buttons">
                        <button
                            ...
                            onClick={() => onSettingsChange({
                                ...
                                temperature: 0.3,
                                maxTokens: 1000,
                                systemPrompt: 'You are a precise regulatory compliance assistant. Provide accurate, fact-based responses about medical device regulations.',
                                enableRAG: true,
                                enableMCP: true
                            })}
                        >
                        ...
                        <button
                            ...
                            onClick={() => onSettingsChange({
                                ...
                                temperature: 0.7,
                                maxTokens: 2000,
                                systemPrompt: 'You are an expert regulatory consultant. Provide comprehensive, detailed guidance on medical device compliance with practical examples.',
                                enableRAG: true,
                                enableMCP: true
                            })}
                        >
                        ...
                        <button
                            ...
                            onClick={() => onSettingsChange({
                                ...
                                temperature: 0.5,
                                maxTokens: 500,
                                systemPrompt: 'You are a helpful regulatory assistant. Provide clear, concise answers to compliance questions.',
                                enableRAG: false,
                                enableMCP: false
                            })}
                        >
                    ...
                    <button
                        ...
                        onClick={() => {
                            ...
                            onSettingsChange({
                                ...
                                temperature: 0.7,
                                maxTokens: 1000,
                                systemPrompt: 'You are an expert AI assistant specializing in medical device regulatory compliance. Provide accurate, helpful, and detailed responses about FDA regulations, medical device classifications, quality management systems, and regulatory pathways.',
                                enableRAG: true,
                                enableMCP: true
                            });
                        }}
