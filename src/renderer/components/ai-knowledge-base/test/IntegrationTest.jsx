  ...
  const runTests = async () => {
    ...
    try {
      ...
      results.clipboard = {
        ...
        message: clipboardSupported
          ? 'Clipboard API available'
          : 'Clipboard API not supported (copy features may not work)',
      };
    } catch (error) {
      results.clipboard = {
        status: 'fail',
  ...
  return (
    ...
    >
      ...
      {Object.keys(testResults).length > 0 && (
        ...
        >
          <h3 style={{ margin: '0 0 1rem 0', color: '#1f2937' }}>📊 Summary</h3>
