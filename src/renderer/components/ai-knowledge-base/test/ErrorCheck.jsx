...
const ErrorCheck = () => {
  ...
  useEffect(() => {
    const checkSystems = () => {
      ...
      // Check components
      const componentsStatus = document.querySelector('.ai-knowledge-base-container')
        ? 'pass'
        : 'pending';
      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: '8px' }}>
        {[
          ...
          { key: 'fonts', label: 'System Fonts', desc: 'Using secure local fonts' },
          {
            ...
            desc: 'Properly configured for Electron',
          },
          ...
          >
            <span style={{ fontSize: '16px' }}>{getStatusIcon(status[key])}</span>
            <div style={{ flex: 1 }}>
              <div
                style={{
                  fontSize: '14px',
