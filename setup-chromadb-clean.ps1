...
# Install ChromaDB
Write-Host "3. Installing ChromaDB..." -ForegroundColor Yellow
try {
...
Write-Host "4. Setting up ChromaDB storage on E: drive..." -ForegroundColor Yellow
...
Write-Host "5. Testing ChromaDB installation..." -ForegroundColor Yellow
try {
    python -c "import chromadb; print('ChromaDB import successful')"
    Write-Host "ChromaDB test passed!" -ForegroundColor Green
} catch {
    Write-Host "ChromaDB test failed, but installation may still work" -ForegroundColor Yellow
}

Write-Host "`nChromaDB Setup Complete!" -ForegroundColor Green
...
Write-Host "`nBenefits of ChromaDB:" -ForegroundColor Yellow
...
Write-Host "`nYour Complete Free AI Stack:" -ForegroundColor Green
